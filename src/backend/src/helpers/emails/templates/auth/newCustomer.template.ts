...
<head>
  ...
  <title>Bienvenido a SimpleFit</title>
  <style type="text/css">
          ...
          <tr>
            <td style="padding:40px 40px 32px 40px;">
              ...
              <h1 style="font-size:22px;margin:0 0 16px 0;color:#1a2228;font-family:Arial,sans-serif;">
                Hola ${name}, ¡bienvenido a SimpleFit!
              </h1>

              <p style="margin:0 0 12px 0;font-size:15px;line-height:24px;color:#444444;font-family:Arial,sans-serif;">
                Tu cuenta ha sido creada exitosamente. Utiliza las siguientes credenciales para acceder por primera vez:
              </p>
              ...
              <p style="margin:0 0 8px 0;font-size:13px;line-height:20px;color:#888888;font-family:Arial,sans-serif;font-style:italic;">
                Esta contraseña es temporal. Deberás establecer una nueva contraseña después de iniciar sesión por primera vez.
              </p>
